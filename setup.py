...
setup(name="wolof_translate", version="0.0.1", author="Oumar Kane", author_email="oumar.kane@univ-thies.sn", 
      ...
      install_requires=['spacy', 'nltk', 'gensim', 'furo', 'nbsphinx', 'streamlit', 'tokenizers', 'evaluate', 'transformers', 'pandas', 'numpy', 'scikit-learn', 'matplotlib', 'plotly', 'sacrebleu', 'nlpaug', 'wandb', 'pytorch_lightning', 'selenium', 'sentencepiece'])
