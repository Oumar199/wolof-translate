            ...
            if line != '' and line != sep:
                ...
                if i > 1:
                    ...
                    try:
                        ...
                        line = line[0].upper() + line[1:] if new_poem[i-1][j][0].isupper() else line[0].lower() + line[1:]

                    except IndexError:
                        
                        raise IndexError("The number of lines in the different corpora are not the sames !")
