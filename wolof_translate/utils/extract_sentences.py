...
class ExtractRelatedSentences:
    ...
    def save_data_frame(self, storage: str = "data/extractions/new_data/sent_extraction.txt", csv_file_path: str = "data/extractions/new_data/sent_extraction.csv", **kwargs):
        ...
        for i in range(2, self.length + 1):
            ...
            data_frame = pd.concat((data_frame, pd.DataFrame.from_dict(self.sentences[i], orient='columns')))
        
        data_frame.rename(columns={'1': self.corpus_1, '2': self.corpus_2}, inplace=True)
